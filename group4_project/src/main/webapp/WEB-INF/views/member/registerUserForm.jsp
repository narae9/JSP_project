...
<div class="page-main">
	...
	<div class="content">
		...
		<form id="register_form" action="registerUser.do" method="post">
			...
			<!-- 아이디/중복확인 -->
			<div class="form_text">
				<span class="text_f">아이디</span><span class="text_notice">(*영문 또는 숫자 4자~10자)</span><br>
			...
			<!-- 비밀번호 -->
			<div class="form_text">
				<span class="text_f">비밀번호</span><br>
			...
			<!-- 생년월일 -->
			<div class="form_text">
				<span class="text_f">생년월일</span><br>
				<input type="date" id="agecode" name="agecode">
			</div><br>
			
			<!-- 이메일 -->
			<div class="form_text">
				<span class="text_f">이메일</span>
				<input type="text" id="email" name="email" maxlength="50">
			</div><br>
			
			<!-- 전화번호 -->
			<div class="form_text">
				<span class="text_f">전화번호</span>
				<input type="text" id="phone" name="phone" maxlength="15">
			</div><br>
			
			<!-- 우편번호 -->
			<div class="form_text">
				<span class="text_f">우편번호</span><br>
